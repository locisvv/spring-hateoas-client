...
//        assertEquals(expectedArtist.getEmbedded().getName(), actualArtist.getEmbedded().getName());
//    }
//
//    @Test
...
//        assertTrue(actualArtist.getEmbedded().isEmpty());
//    }
//
//    @Test
...
//        assertEquals(expectedArtist.getLinks(), actualArtist.getLinks());
//        assertEquals(expectedArtist.getEntity().getTitle(), actualArtist.getEntity().getTitle());
//        assertEquals(expectedArtist.getEmbedded().iterator().next().getName(), actualArtist.getEmbedded().iterator().next().getName());
//    }
//
//}